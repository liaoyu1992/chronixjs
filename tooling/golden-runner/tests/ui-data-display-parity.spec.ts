...
/**
 * chronix-ui 3-adapter Descriptions + List parity spec — Phase 21
 * (2026-06-03). Same testid → identical DOM fingerprint (tag +
 * sorted class set + role) across vue3 / vue2 / react.
 *
 * Descriptions root tag is `<div>`; List root tag is `<ul>`. Both
 * use static items + no tick-driven divergence so the rendered
 * output is deterministic at fingerprint time.
 */

const DESCRIPTIONS_TESTIDS = [
  'descriptions-default',
  'descriptions-bordered',
  'descriptions-vertical',
  'descriptions-with-span',
  'descriptions-with-title',
  'descriptions-small',
] as const;
...
makeParityBlock('chronix-ui / Descriptions 3-adapter parity', DESCRIPTIONS_TESTIDS, 'descriptions');
makeParityBlock('chronix-ui / List 3-adapter parity', LIST_TESTIDS, 'list');
