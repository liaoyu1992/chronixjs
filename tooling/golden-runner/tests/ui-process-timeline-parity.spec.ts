...
/**
 * chronix-ui 3-adapter Steps + Timeline parity spec — Phase 20
 * (2026-06-03). Same testid → identical DOM fingerprint (tag +
 * sorted class set + role) across vue3 / vue2 / react.
 *
 * Steps + Timeline both use static items (no tick-driven divergence)
 * so the rendered output is deterministic at fingerprint time.
 */
...
makeParityBlock('chronix-ui / Steps 3-adapter parity', STEPS_TESTIDS, 'steps');
makeParityBlock('chronix-ui / Timeline 3-adapter parity', TIMELINE_TESTIDS, 'timeline');
