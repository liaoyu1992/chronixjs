      ...
      {hasSidebar ? (
        <div
          ...
          style={{
            ...
            // above). overflow-x auto so a narrowed sidebar can still
            // scroll its columns. scrollbar-gutter: stable keeps content
            // width constant whether or not the scrollbar shows →
