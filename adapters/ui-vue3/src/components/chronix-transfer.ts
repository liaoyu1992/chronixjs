  ...
  setup(props, { emit, attrs }) {
    ...
    function renderPanel(
      ...
      return h(
        ...
        [
          // Header
          h('div', { class: 'cx-ui-transfer__header' }, [
          ...
          props.filterable
            ? h('div', { class: 'cx-ui-transfer__filter' }, [
                h('input', {
                  ...
                  value: filterValue,
                  placeholder: position === 'source' ? 'Search...' : 'Search...',
                  onInput: (e: Event) => {
              ...
              : items.map((opt) =>
                  h(
                    'div',
                    {
                      ...
                      'data-testid': `transfer-item-${opt.value}`,
                      onClick: () => {
    ...
    return () =>
      h('div', { class: rootClass.value, ...attrs, 'data-testid': 'transfer-root' }, [
        renderPanel(
          'source',
          props.sourceTitle,
        ...
        h('div', { class: 'cx-ui-transfer__actions' }, [
          h(
            'button',
            {
              ...
              disabled: sourceChecked.value.size === 0,
          ...
          h(
            ...
            {
              class: 'cx-ui-transfer__action-btn',
              disabled: targetChecked.value.size === 0,
