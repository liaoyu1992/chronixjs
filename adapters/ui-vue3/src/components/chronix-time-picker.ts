...
/**
 * `<ChronixTimePicker>` — Vue 3 time picker with scrollable columns.
 * Phase 32 (2026-06-05). Single time selection.
 */
        ...
        [
          h('div', { class: triggerClass.value }, [
            ...
            props.clearable && props.value !== undefined
              ? h('span', { class: 'cx-ui-time-picker__clear', onMousedown: clearValue }, '✕')
              : null,
