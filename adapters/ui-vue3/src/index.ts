/**
 * @chronixjs/ui-vue3 — Vue 3 adapter for the chronix-ui core IR.
 *
 * Phase 11 (2026-06-02): package skeleton + first rendering surface —
 *   `<ChronixUIProvider>` + `useUIContext()` (Phase 0.3 Decision A.1 +
 *   B.1 in action) + `<ChronixButton>` first Tier A component pilot.
 *
 * Subsequent component phases extend per the roadmap in
 * `audit/UI_MIGRATION_PLAN.md`.
 */

export const UI_VUE3_PACKAGE_VERSION = '0.1.0-alpha.0';
...
} from './components/chronix-button-styles.js';
