...
/**
 * Mirror Phase 27.1's pattern: stub ResizeObserver so the SFC test
...
describe('<ChronixGantt> viewport-aware bar title + progress-dot positioning — Phase 28.2.1', () => {
  ...
  it('underlying resize edge-zone hit-test rect stays at bar geometric edge under viewport-clip (visual + hit-test diverge by design)', async () => {
    ...
    // Sanity: this is upstream of the viewport (60 < scrollLeft 300) —
