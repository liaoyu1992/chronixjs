...
const bars: BarSpec[] = [
  {
    ...
    progress: { value: 80, showText: true },
  },
  {
    id: 'bar-2',
    rowId: 'row-2',
    range: { start: new Date('2026-01-12'), end: new Date('2026-01-28') },
    title: 'Frontend',
    dprIntent: 'crisp-pixel',
    progress: { value: 40, showText: true },
  },
  {
    id: 'bar-3',
    rowId: 'row-3',
    range: { start: new Date('2026-01-25'), end: new Date('2026-02-05') },
    title: 'QA',
    dprIntent: 'crisp-pixel',
  },
];
