...
const rows: RowSpec[] = [
  ...
  { id: 'row-3', columns: { name: '交互设计' } },
  { id: 'row-4', columns: { name: '前端开发' } },
  { id: 'row-5', columns: { name: '后端开发' } },
  { id: 'row-6', columns: { name: 'API 联调' } },
  { id: 'row-7', columns: { name: '数据库设计' } },
  { id: 'row-8', columns: { name: '单元测试' } },
  { id: 'row-9', columns: { name: '集成测试' } },
  { id: 'row-10', columns: { name: '性能优化' } },
  { id: 'row-11', columns: { name: '安全审计' } },
  { id: 'row-12', columns: { name: '文档编写' } },
  { id: 'row-13', columns: { name: '部署上线' } },
  { id: 'row-14', columns: { name: '用户培训' } },
];
...
const bars: BarSpec[] = [
  ...
  },
  {
    id: 'bar-3',
    rowId: 'row-3',
    range: { start: new Date('2026-01-12'), end: new Date('2026-01-22') },
    title: '交互设计',
    dprIntent: 'crisp-pixel',
  },
  {
  ...
  },
  {
    id: 'bar-5',
    rowId: 'row-5',
    range: { start: new Date('2026-01-18'), end: new Date('2026-02-15') },
    title: '后端开发',
    dprIntent: 'crisp-pixel',
  },
  {
    id: 'bar-6',
    rowId: 'row-6',
    range: { start: new Date('2026-02-01'), end: new Date('2026-02-12') },
    title: 'API 联调',
    dprIntent: 'crisp-pixel',
  },
  {
  ...
  },
  {
    id: 'bar-10',
    rowId: 'row-10',
    range: { start: new Date('2026-02-15'), end: new Date('2026-02-25') },
    title: '性能优化',
    dprIntent: 'crisp-pixel',
  },
  {
    id: 'bar-11',
    rowId: 'row-11',
    range: { start: new Date('2026-02-18'), end: new Date('2026-02-28') },
    title: '安全审计',
    dprIntent: 'crisp-pixel',
  },
  {
    id: 'bar-12',
    rowId: 'row-12',
    range: { start: new Date('2026-02-20'), end: new Date('2026-03-01') },
    title: '文档编写',
    dprIntent: 'crisp-pixel',
  },
  {
