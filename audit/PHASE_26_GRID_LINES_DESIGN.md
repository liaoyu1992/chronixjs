# Phase 26 — Grid lines (vertical cell-boundary + sub-slot dashed + week-start emphasis + horizontal row-bottom)
...
| Vertical sub-slot `gantt-grid-vline-dashed` (`<line>` with `strokeDasharray="2,2"`)                   | Non-boundary branch (976-990) when `showDashedNonBoundaries=true`                                 | ✅ **port** as `cx-gantt-grid-vline-dashed`                                                                                                                                                                                                                                                                |
