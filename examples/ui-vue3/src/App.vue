...
function handlePageHeaderBack() {
  pageHeaderBackCount.value += 1;
}

function handleBreadcrumbItemClick(_item: BreadcrumbItem) {
...
const PHASE28_COLLAPSE_ITEMS: readonly CollapseItem[] = [
  {
    key: 'a',
    title: 'Panel A',
    content: 'Body of panel A — auto height transition.',
    disabled: false,
  },
  {
    key: 'b',
    title: 'Panel B (disabled)',
    content: 'Cannot expand this one.',
    disabled: true,
  },
  {
    key: 'c',
    title: 'Panel C',
    content: 'Body of panel C — multi-expand mode.',
    disabled: false,
  },
];
...
const PHASE31_TREE_DATA: readonly import('@chronixjs/ui').TreeNodeSpec<
  import('@chronixjs/ui').TreeNodeData
>[] = [
  {
    key: 't1',
...
const PHASE31_CASCADER_OPTIONS: readonly import('@chronixjs/ui').SelectOption[] = [
  {
    key: 'zhejiang',
    label: 'Zhejiang',
    children: [
...
const PHASE31_MENTION_OPTIONS: readonly import('@chronixjs/ui').SelectOption[] = [
    ...
    <div class="demo-page" data-testid="demo-page">
      ...
      <section class="demo-section">
        ...
        <div class="demo-row">
          ...
          <ChronixTag round data-testid="tag-round">Round</ChronixTag>
          <ChronixTag type="primary" closable data-testid="tag-closable" @close="handleTagClose">
            Closable
          </ChronixTag>
          <ChronixTag disabled data-testid="tag-disabled">Disabled</ChronixTag>
        </div>
        <div class="demo-counter">
          Tag close count:
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; max-width: 360px">
          <ChronixInput
            ...
            @update:value="(v: string) => (phase25InputText = v)"
          />
          <ChronixInput
            ...
            @update:value="(v: string) => (phase25InputTextarea = v)"
          />
          <ChronixInput
            :value="phase25InputClearable"
            :clearable="true"
            data-testid="phase25-input-clearable"
            @update:value="(v: string) => (phase25InputClearable = v)"
          />
          <ChronixInputOtp
            :value="phase25Otp"
            :length="6"
            data-testid="phase25-input-otp"
            @update:value="(v: string) => (phase25Otp = v)"
          />
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          <ChronixCheckbox
            ...
            @update:checked="(v: boolean) => (phase25CheckboxChecked = v)"
          />
          <ChronixCheckbox
            :checked="true"
          ...
          <ChronixSwitch
            ...
            @update:checked="(v: boolean) => (phase25SwitchChecked = v)"
          />
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          <ChronixRadioGroup
            ...
            @update:value="(v: string) => (phase25RadioValue = v)"
          />
          <ChronixRate
            :value="phase25Rate"
            data-testid="phase25-rate"
            @update:value="(v: number) => (phase25Rate = v)"
          />
          <ChronixRate
            :value="phase25RateHalf"
            :allowHalf="true"
            data-testid="phase25-rate-half"
            @update:value="(v: number) => (phase25RateHalf = v)"
          />
          <ChronixInputNumber
            ...
            @update:value="(v: number | null) => (phase25NumberValue = v)"
          />
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; max-width: 360px">
          <ChronixAutoComplete
            ...
            @update:value="(v: string) => (phase25AutoCompleteValue = v)"
          />
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; flex-direction: column; gap: 100px; margin-top: 80px">
          ...
          <ChronixPopSelect
            ...
            @update:value="(v: string) => (phase26PopSelectValue = v)"
          >
      ...
      <section class="demo-section">
        ...
        <ChronixModal
          ...
          @update:show="(v) => (phase27ModalShow = v)"
        >
          Modal body content.
          <template #footer>
        ...
        <ChronixDrawer
          ...
          @update:show="(v) => (phase27DrawerShow = v)"
        >
          Drawer body content.
        </ChronixDrawer>
      </section>
      ...
      <section class="demo-section">
        ...
        <ChronixCollapse
          v-model:value="phase28CollapseValue"
      ...
      <section class="demo-section">
        <h2>Carousel</h2>
        <ChronixCarousel
          v-model:value="phase29CarouselValue"
      ...
      <section class="demo-section">
        ...
        <ChronixTree
          v-model:value="phase30TreeValue"
      ...
      <section class="demo-section">
        ...
        <ChronixTree
          v-model:value="phase30VirtualTreeValue"
      ...
      <section class="demo-section">
        ...
        <ChronixSelect
          ...
          v-model:value="phase31SelectValue"
          placeholder="Select..."
      ...
      <section class="demo-section">
        ...
        <ChronixSelect
          :options="PHASE31_SELECT_OPTIONS"
          v-model:value="phase31SelectMultiValue"
          :multiple="true"
          placeholder="Select..."
      ...
      <section class="demo-section">
        ...
        <ChronixTreeSelect
          ...
          v-model:value="phase31TreeSelectValue"
          :expanded-keys="phase31TreeSelectExpandedKeys"
          placeholder="Select node..."
          @update:expanded-keys="(keys) => (phase31TreeSelectExpandedKeys = keys)"
      ...
      <section class="demo-section">
        ...
        <ChronixCascader
          ...
          v-model:value="phase31CascaderValue"
          placeholder="Select..."
      ...
      <section class="demo-section">
        ...
        <ChronixMention
          ...
          v-model:value="phase31MentionValue"
      ...
      <section class="demo-section">
        <h2>DatePicker</h2>
        <ChronixDatePicker
          v-model:value="phase32DatePickerValue"
      ...
      <section class="demo-section">
        <h2>TimePicker</h2>
        <ChronixTimePicker
          v-model:value="phase32TimePickerValue"
      ...
      <section class="demo-section">
        <h2>Calendar</h2>
        <ChronixCalendar v-model:value="phase32CalendarValue" data-testid="phase32-calendar" />
      </section>

      <section class="demo-section">
        <h2>ColorPicker</h2>
        <ChronixColorPicker
          v-model:value="phase33ColorPickerValue"
      ...
      <section class="demo-section">
        <h2>Transfer</h2>
        <ChronixTransfer
          v-model:value="phase33TransferValue"
          :options="[
            { label: 'Apple', value: 'a' },
      ...
      <section class="demo-section">
        <h2>Slider</h2>
        <ChronixSlider
          v-model:value="phase33SliderValue"
          :min="0"
          :max="100"
      ...
      <section class="demo-section">
        <h2>Pagination</h2>
        <ChronixPagination
          v-model:page="phase33PaginationPage"
          :page-count="10"
      ...
      <section class="demo-section">
        <h2>DynamicInput</h2>
        <ChronixDynamicInput
          v-model:value="phase35DynamicInputValue"
      ...
      <section class="demo-section">
        <h2>DynamicTags</h2>
        <ChronixDynamicTags
          v-model:value="phase35DynamicTagsValue"
