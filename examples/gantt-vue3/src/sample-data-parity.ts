 ...
 * `?parity=true`). Mirrors the original spec demo's `RESOURCES[]` +
 ...
 *   reference's `RESOURCES[]` input order. Result: rendered Y will NOT
 *   match the original rendered Y. Cross-demo parity
...
/**
 * parity-mode link set, mirroring the 8-edge curated
