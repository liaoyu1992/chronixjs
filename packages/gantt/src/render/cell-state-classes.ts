 ...
 * cells.
 *
 * Class names mirror the parity-reference convention with the chronix
 * `cx-` prefix:
 *
...
/**
 * Sun-anchored weekday ids matching the parity-reference `DAY_IDS`
 ...
 * state modifiers append when applicable. Matches the parity reference
 * by omitting `-other` (k-ui's `getSlotClassNames` also omits it).
 */
